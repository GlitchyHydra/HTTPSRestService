...
{
    public class FreelancerAuthOptions : AuthenticationSchemeOptions
    {
        /// <summary>
        ...
        /// </summary>
        public string Challenge { get; set; } = FreelancerAuthDefaults.AuthenticationScheme;
        ...
        /// </summary>
        public new FreelancerAuthEvents Events
        {
            get { return (FreelancerAuthEvents)base.Events; }
